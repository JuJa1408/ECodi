...
FILE_LIST=`ls $WORK_DIR/TrimGalore_result/*_1_val_1.fq.gz | sed "s/_1_val_1.fq.gz//"`
...
apptainer exec $CONTAINER samtools view -b -S -o $WORK_DIR/Bam_files/${id}.bam $WORK_DIR/Sam_files/${id}Aligned.out.sam
done
